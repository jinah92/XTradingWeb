        ...
        <div key={comment.commentId}>
          <div className="flex justify-between">
            <div className="flex items-start sm:items-center">
              ...
              <div className="cursor-pointer flex flex-col items-start sm:items-center sm:flex-row sm:text-sm text-xs font-semibold">
                ...
                <span className="p-1 ml-1 sm:text-sm text-xs text-blue-500">{comment.createdByUserGrade}</span>
              </div>
          ...
          <div>
            <div className="flex mt-3 text-xs text-slate-400 font-semibold justify-between">
              ...
              <div className="flex text-black dark:text-white cursor-pointer items-center">
                <span className="" onClick={setReplyFormToggle}>
                  대댓글 작성
                </span>
                {replyForm ? (
                    ...
                    <div className="flex justify-between">
                      <div className="flex items-start sm:items-center">
                        ...
                        <div className="cursor-pointer flex flex-col items-start sm:items-center sm:flex-row sm:text-sm text-xs font-semibold">
                          ...
                          <span className="p-1 ml-1 sm:text-sm text-xs text-blue-500">{reply.createdByUserGrade}</span>
                        </div>
                        <span className="text-xs ml-1 text-slate-400 font-medium">
                        ...
                        {reply.youCreate ? (
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent>
                              ...
                              <DropdownMenuItem onClick={() => commentDelete(reply.commentId)}>
                                삭제하기
                              </DropdownMenuItem>
                            </DropdownMenuContent>
                          </DropdownMenu>
        ...
        <>
          ...
          <div className="mt-5">
            <CommentInput
              targetId={comment.commentId}
              refresh={commentSearch}
              beforeContent={comment.contents}
              type="modify"
            ></CommentInput>
            {/* 대댓글 표시 영역 */}
            <div className="ml-8 mt-4">
